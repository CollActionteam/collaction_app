...
Either<ValueFailure<String>, String> validateUsername(String input) {
  ...
  if (!input.startsWith(RegExp("[a-zA-Z0-9]"))) {
    return left(ValueFailure.notStartWithLetter(failedValue: input));
  }
