...
class SpotLightBloc extends Bloc<SpotLightEvent, SpotLightState> {
  ...
  SpotLightBloc(this._crowdActionRepository) : super(const SpotLightState.initial());

  @override
  Stream<SpotLightState> mapEventToState(SpotLightEvent event)async* {
    yield* event.map(getSpotLightCrowdActions: _mapGetSpotLightCrowdActionsToState);
  }
